...
public class BattleService(IDbConnectionFactory connectionFactory)
{
    ...
    public async Task<Battle> CreateBattle(Guid userId, int attackerSpaceshipId, int defenderPlanetId, BattleLogRequest battleLog, bool attackerWon, DbTransaction? transaction = null)
{
    ...
    // Execute the query and return the inserted battle data
